        ...
        [
            ...
            Workout(
                ...
                exercises: [
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "Feet shoulder-width. Push through heels.", sets: 3, reps: "10–12"),
                    Exercise(name: "Chest Press", equipment: .homeGym, sets: 3, reps: "10"),
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "Narrow stance. Push through heels.", sets: 3, reps: "10–12"),
                    Exercise(name: "Chest Press", equipment: .homeGym, instructions: "Incline if available. 3 sets of 10.", sets: 3, reps: "10"),
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "Wide stance for glutes. 3 sets.", sets: 3, reps: "10–12"),
                    Exercise(name: "Chest Press", equipment: .homeGym, instructions: "Flat bench. Control the negative.", sets: 3, reps: "10"),
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "Single leg if possible. 8 each.", sets: 3, reps: "8 each"),
                    Exercise(name: "Chest Press", equipment: .homeGym, instructions: "Moderate weight, 12 reps.", sets: 3, reps: "12"),
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "Pause at bottom 1 sec. 10 reps.", sets: 3, reps: "10"),
                    Exercise(name: "Chest Press", equipment: .homeGym, instructions: "Slow tempo: 3 sec down, 2 sec up.", sets: 3, reps: "10"),
                ],
                estimatedMinutes: 25,
                profileType: .mom,
                primaryFocus: .fullBody
            ...
            Workout(
                ...
                exercises: [
                    ...
                    Exercise(name: "Leg Press", equipment: .homeGym, instructions: "High feet on platform for glute focus.", sets: 3, reps: "10–12"),
                ],
                estimatedMinutes: 28,
                profileType: .mom,
                primaryFocus: .glutes
